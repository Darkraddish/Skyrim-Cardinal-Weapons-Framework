...
def main():
    ...
    cpp_files = [
        ...
        os.path.join(INCLUDE_DIR, "ProgressionEngine.h"),
        ...
        os.path.join(INCLUDE_DIR, "CardinalTreeUIManager.h"),
        os.path.join(SRC_DIR, "CardinalTreeUIManager.cpp"),
        ...
        os.path.join(PAPYRUS_DIR, "CWFramework_AnimationAPI.psc"),
    ]
